...
INSERT INTO `dynamic_menu` (`id`, `parent_id`, `title`, `url`, `menu_order`, `status`, `level`, `icon`, `description`) VALUES ('2', '1', 'Pengguna', 'user', '0', '1', '1', 'fa fa-user', NULL);
...
INSERT INTO `dynamic_menu` (`id`, `parent_id`, `title`, `url`, `menu_order`, `status`, `level`, `icon`, `description`) VALUES ('19', '0', 'Plugin', '', '0', '1', NULL, 'fa fa-external-link', NULL);
INSERT INTO `dynamic_menu` (`id`, `parent_id`, `title`, `url`, `menu_order`, `status`, `level`, `icon`, `description`) VALUES ('20', '4', 'Pelamar', '', '0', '1', NULL, 'fa fa-user', NULL);
...
INSERT INTO `dynamic_menu` (`id`, `parent_id`, `title`, `url`, `menu_order`, `status`, `level`, `icon`, `description`) VALUES ('47', '45', ' Perjalanan Dinas', '', '0', '1', NULL, NULL, NULL);
...
INSERT INTO `dynamic_menu` (`id`, `parent_id`, `title`, `url`, `menu_order`, `status`, `level`, `icon`, `description`) VALUES ('67', '19', 'card_presensi', 'barcode', '0', '1', NULL, NULL, NULL);
...
INSERT INTO `dynamic_menu` (`id`, `parent_id`, `title`, `url`, `menu_order`, `status`, `level`, `icon`, `description`) VALUES ('71', '68', 'Pengumuman', 'news', '0', '1', NULL, NULL, NULL);
...
INSERT INTO `login_attempts` (`id`, `ip_address`, `login`, `time`) VALUES ('3', '::1', 'mmk', '1483840464');
INSERT INTO `login_attempts` (`id`, `ip_address`, `login`, `time`) VALUES ('4', '::1', 'yuj', '1483841240');
INSERT INTO `login_attempts` (`id`, `ip_address`, `login`, `time`) VALUES ('7', '::1', 'mucharomtzaka2222@yahoo.co.id', '1483842992');
...
INSERT INTO `plugin_module` (`id`, `name_modules`, `status_modules`, `plug_id_dynamic_menu`) VALUES ('1', 'kartu presensi pegawai', '1', '19');
...
INSERT INTO `role_premission` (`id`, `groups_id`, `plugin_id`, `view`, `edit`, `remove`, `download`) VALUES ('1', '1', '1', '1', '1', '1', '1');
