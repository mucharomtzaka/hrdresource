...
INSERT INTO `dynamic_menu` (`id`, `parent_id`, `title`, `url`, `menu_order`, `status`, `level`, `icon`, `description`) VALUES ('64', '0', 'Master Referense', '#', '0', '1', '0', 'fa fa-database', '');
INSERT INTO `dynamic_menu` (`id`, `parent_id`, `title`, `url`, `menu_order`, `status`, `level`, `icon`, `description`) VALUES ('65', '64', 'Pendidikan', 'Studies/index', '0', '1', '0', '', '');
INSERT INTO `dynamic_menu` (`id`, `parent_id`, `title`, `url`, `menu_order`, `status`, `level`, `icon`, `description`) VALUES ('66', '64', 'Jabatan', 'Jabatan/index', '0', '1', '0', '', '');
INSERT INTO `dynamic_menu` (`id`, `parent_id`, `title`, `url`, `menu_order`, `status`, `level`, `icon`, `description`) VALUES ('95', '102', 'News', 'plugin/News/index', '0', '1', '0', '', '');
INSERT INTO `dynamic_menu` (`id`, `parent_id`, `title`, `url`, `menu_order`, `status`, `level`, `icon`, `description`) VALUES ('96', '0', 'Master Menu', '#', '0', '1', '0', 'fa fa-list', '');
INSERT INTO `dynamic_menu` (`id`, `parent_id`, `title`, `url`, `menu_order`, `status`, `level`, `icon`, `description`) VALUES ('97', '96', 'Menu Navigasi Front', 'navbarplug/index', '0', '0', '0', '', '');
INSERT INTO `dynamic_menu` (`id`, `parent_id`, `title`, `url`, `menu_order`, `status`, `level`, `icon`, `description`) VALUES ('98', '96', 'Menu Baru', 'navbarplug/create', '0', '0', '0', '', '');
INSERT INTO `dynamic_menu` (`id`, `parent_id`, `title`, `url`, `menu_order`, `status`, `level`, `icon`, `description`) VALUES ('100', '102', 'Newscategori', 'plugin/Newscategori', '0', '1', '0', '', '');
INSERT INTO `dynamic_menu` (`id`, `parent_id`, `title`, `url`, `menu_order`, `status`, `level`, `icon`, `description`) VALUES ('101', '102', 'Groupnews', 'plugin/Groupnews', '0', '1', '0', '', '');
INSERT INTO `dynamic_menu` (`id`, `parent_id`, `title`, `url`, `menu_order`, `status`, `level`, `icon`, `description`) VALUES ('102', '0', 'Master Berita', '#', '0', '0', '0', 'fa fa-envelope', '');
...
INSERT INTO `groupnews` (`id`, `Categories_id`, `news_id`) VALUES ('1', '2', '2');
...
INSERT INTO `login_attempts` (`id`, `ip_address`, `login`, `time`) VALUES ('1', '::1', 'mucharomtzaka@yahoo.co.id', '1484130771');
INSERT INTO `login_attempts` (`id`, `ip_address`, `login`, `time`) VALUES ('2', '::1', 'mucharomtzaka@yahoo.co.id', '1484130788');
...
INSERT INTO `migrations` (`version`) VALUES ('20170111050724');


#
# TABLE STRUCTURE FOR: navbarplug
#

DROP TABLE IF EXISTS `navbarplug`;

CREATE TABLE `navbarplug` (
  `id_navbar` int(11) NOT NULL AUTO_INCREMENT,
  `navbar_menu` varchar(50) NOT NULL,
...
INSERT INTO `navbarplug` (`id_navbar`, `navbar_menu`, `url`, `icon`, `parent_id`) VALUES ('2', 'News', 'news', 'fa fa-list', '0');
...
INSERT INTO `news` (`id`, `title`, `slug`, `text`) VALUES ('1', 'Contoh', 'Contoh', 'Twitter, 2010. About Bootstrap. [Online] \r\nAvailable at: http://getbootstrap.com/about/\r\n[Diakses 15 April 2016].');
INSERT INTO `news` (`id`, `title`, `slug`, `text`) VALUES ('2', 'Intisari', 'Intisari', 'Saat ini STMIK Jenderal Achmad Yani sudah memiliki sebuah Sistem Informasi Akademik (SIA) yang terkomputerisasi dan online. SIA tersebut digunakan untuk pelayanan administrasi akademik seperti pembagian kelas, Kartu Rencana Studi (KRS),  pemberian nilai dan pembuatan Kartu Hasil Studi (KHS), penjadwalan kuliah, dan sebagainya. Namun SIA yang ada  tidak mencakup proses monitoring dan evaluasi perkuliahan, seperti: perubahan jadwal kuliah di tengah semester, pencatatan presensi mahasiswa, serta pencatatan hasil kuisioner dosen. Beberapa proses yang terkait dengan monitoring dan evaluasi perkuliahan tersebut saat ini masih dilakukan secara manual atau menggunakan aplikasi semacam Microsoft Office Excel.');
INSERT INTO `news` (`id`, `title`, `slug`, `text`) VALUES ('3', 'Test', 'Test', 'Menentukan kebutuhan sistem yang dibuat dalam bentuk yang dapat dimengerti oleh klien dan staf pengembang. Dalam tahap ini klien atau pengguna menjelaskan segala kendala dan tujuan serta mendefinisikan apa yang diinginkan dari sistem. Setelah dokumen spesifikasi disetujui maka dokumen tersebut menjadi kontrak kerja antara klien dan pihak  pengembang');
INSERT INTO `news` (`id`, `title`, `slug`, `text`) VALUES ('4', 'Arsip', 'Arsip', 'Arsip');
INSERT INTO `news` (`id`, `title`, `slug`, `text`) VALUES ('5', 'WDS', 'wds', 'wds');
INSERT INTO `news` (`id`, `title`, `slug`, `text`) VALUES ('6', 'root', 'root', 'root');
INSERT INTO `news` (`id`, `title`, `slug`, `text`) VALUES ('7', 'yhu', 'yhu', 'yhu');


#
# TABLE STRUCTURE FOR: newscategori
#

DROP TABLE IF EXISTS `newscategori`;

CREATE TABLE `newscategori` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Categories` varchar(128) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

INSERT INTO `newscategori` (`id`, `Categories`) VALUES ('1', 'Artikel');
INSERT INTO `newscategori` (`id`, `Categories`) VALUES ('2', 'Pengumuman');
...
INSERT INTO `settings` (`id`, `header_title`, `footer_title`, `meta_title`, `themes`, `image_favicon`, `backgrounds`, `name_company`, `address_company`, `contact_company`, `name_company_profil_des`, `site_offline`) VALUES ('1', 'Aplikasi HRD ', 'Aplikasi  Human Resources Development System Version 1.0', 'Aplikasi Human Resource Development ( HRD) ', 'skin-blue-light', 'myfhoto.jpg', NULL, '', '', '', '', '0');
